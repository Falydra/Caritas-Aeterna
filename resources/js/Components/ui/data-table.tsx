...
import {
  ...
  TableHeader,
  TableRow,
} from "@/Components/ui/table" // Make sure this path is correct for your project
...
export function DataTable<TData, TValue>({
  ...
  return (
    <div>
      {/* Filtering and Column Visibility -- Optional but good to have */}
      <div className="flex items-center py-4">
        <Input
          placeholder="Filter usernames..." // Example: filter by username
