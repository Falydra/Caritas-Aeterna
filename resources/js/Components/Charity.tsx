...
export default function Page() {
  ...
  return (
    <div className="items-center h-screen justify-center ">
      <section className="h-full bg-primary-bg flex flex-col items-center justify-start py-8">
       
        <div className="transform w-2/12 -translate-y-1/2 top-0 items-center justify-center flex flex-col">
          <div className="relative w-full flex items-center justify-center px-1 py-1 bg-gray-700 border border-gray-600 rounded-full">
            ...
            <div
              className={`absolute top-0 left-0 h-full rounded-3xl w-1/2 bg-gradient-to-t from-gray-600 to-transparent shadow-[0_0_10px_3px_rgba(255,255,255,0.3)] transition-transform duration-300 ease-in-out ${
                isMoney ? 'translate-x-0 bg-gradient-to-t from-gray-500 to-transparent' : 'translate-x-full bg-gradient-to-t from-gray-500 to-transparent'
              }`}
            />
        ...
        <div
          id="money-charity"
          className={`w-full text-center items-center flex flex-row h-full justify-center py-8 ${isMoney ? '' : 'hidden'}`}
        >
          <CardWithForm />
        </div>
        ...
        <div
          id="book-charity"
          className={`w-full text-center py-8 ${isBook ? '' : 'hidden'}`}
        >
