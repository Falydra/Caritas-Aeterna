...
export default function Footer() {
    return (
        <div className="flex w-full h-[325px]  md:flex-row flex-row bg-primary-fg items-start py-4 justify-center px-16 gap-8 overflow-y-hidden ">
            <div className="flex flex-col w-4/12 h-full items-start justify-center gap-4">
                <img src="/images/Logo_Undip_Full-removebg-preview.png" className="w-auto flex h-1/3" />
                <div className="flex flex-row items-center justify-start w-full gap-8 h-full">
                    <a href="https://www.facebook.com/undip.official"  className="w-12 h-12 bg-primary-bg rounded-full items-center justify-center flex">
                        <FaFacebook className="w-6 h-6 text-primary-fg" />
                    </a >
                    <a href="https://www.youtube.com/c/UndipTV" className="w-12 h-12 bg-primary-bg rounded-full items-center justify-center flex">
                        <FaYoutube className="w-6 h-6 text-primary-fg" />
                    </a>
                    <a href="https://x.com/undip" className="w-12 h-12 bg-primary-bg rounded-full items-center justify-center flex">
                        <FaXTwitter className="w-6 h-6 text-primary-fg" />
                    </a>
                    <a href="https://www.instagram.com/undip.official/" className="w-12 h-12 bg-primary-bg rounded-full items-center justify-center flex">
